...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ SeeMore)\n/* harmony export */ });\n/* harmony import */ var _utils_domHelper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/domHelper */ \"./src/utils/domHelper.ts\");\n/* harmony import */ var _domain_Movies__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../domain/Movies */ \"./src/domain/Movies.ts\");\n\n\nclass SeeMore {\n    constructor($target) {\n        this.$target = $target;\n        _domain_Movies__WEBPACK_IMPORTED_MODULE_1__[\"default\"].subscribe('movies', this.showButton.bind(this));\n    }\n    setEvent() {\n        (0,_utils_domHelper__WEBPACK_IMPORTED_MODULE_0__.$)('.btn').addEventListener('click', () => {\n            this.showMoreMovies();\n        });\n    }\n    template() {\n        return `<button class=\"btn primary full-width\">더 보기</button>`;\n    }\n    render() {\n        this.$target.insertAdjacentHTML('beforeend', this.template());\n        return this;\n    }\n    showMoreMovies() {\n        if (_domain_Movies__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getIsSearched())\n            _domain_Movies__WEBPACK_IMPORTED_MODULE_1__[\"default\"].searchMovies(_domain_Movies__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getQuery());\n        else\n            _domain_Movies__WEBPACK_IMPORTED_MODULE_1__[\"default\"].setMovies();\n    }\n    showButton() {\n        if (_domain_Movies__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getIsEnd())\n            (0,_utils_domHelper__WEBPACK_IMPORTED_MODULE_0__.$)('button.btn').classList.add('button--hidden');\n        else\n            (0,_utils_domHelper__WEBPACK_IMPORTED_MODULE_0__.$)('button.btn').classList.remove('button--hidden');\n    }\n}\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/components/SeeMore.ts?");
...
/***/ "./src/validation/alertFetchStatus.ts":
/*!********************************************!*\
  !*** ./src/validation/alertFetchStatus.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ alertFetchStatus)\n/* harmony export */ });\n/* harmony import */ var _constant_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../constant/index */ \"./src/constant/index.ts\");\n\nfunction alertFetchStatus(status) {\n    if (status >= 500) {\n        window.alert(_constant_index__WEBPACK_IMPORTED_MODULE_0__.ERROR_MESSAGE.noResponse);\n        return true;\n    }\n    else if (status >= 400) {\n        window.alert(_constant_index__WEBPACK_IMPORTED_MODULE_0__.ERROR_MESSAGE.wrongRequset);\n        return true;\n    }\n    return false;\n}\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/validation/alertFetchStatus.ts?");
